...
# I change a little:
# In 2nd order sampler, kdiffusion use euler if sigmas[i+1] == 0;
# but in sampler scheduler, the last step of this unit of sampler is not necessarily zero, so i change it to s_end, the last item in sigmas.
#===================================================================================
def append_zero(x):
